...
import { latestVersion as version, latestVersionUrl } from '/snippets/automations/globals/globals.mdx';
...
<Tab title="Off-Chain Gateway" icon="floppy-disk">
    ...
    <Steps titleSize="h3">
        ...
        <span style={{fontSize: '1.0rem'}}> *Latest [go-livepeer](`{latestVersionUrl}`) version:* <Badge color="green"><span>{version}</span></Badge> </span>
         <br/>
         <CustomCodeBlock
