...
description: "A look at the Livepeer organisational structure, including the Livepeer Foundation, Livepeer Inc., and the key role of the Livepeer Community in governing the future of network."
  ...
  - Any tokenholder can participate in governance by delegating their tokens to a delegator or running a delegate node themselves.
    <span>
      ...
      <LinkArrow
        ...
        href="(../../06_delegators/delegating-lpt/how-to-delegate-lpt)"
        target="_blank"
        newline={false}
        />
        {" )."} 
