  ...
  **Quick Intro**
  ...
  <Columns cols={2}>
    ...
    <Card
      ...
      arrow
    >
      A canonical model with an [OSI](https://en.wikipedia.org/wiki/OSI_model) stack comparison to help you understand how Livepeer operates in terms of infrastructure layers.
    </Card>
    <Card
      title="Livepeer Protocol"
      icon="cube"
