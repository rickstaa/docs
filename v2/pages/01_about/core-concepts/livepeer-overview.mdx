...
See more on the architectural layers in <LinkArrow href="/about/core-concepts/mental-model" label="Mental Model: OSI Framework for Livepeer" newline={false} />
...
<QuadGrid icon="arrows-spin" iconSize={50}>
  <Card title="Orchestrators" icon="microchip" cta="Go to Orchestrators" href="/orchestrators">
  ...
  <Card title="Gateways" icon="torii-gate" cta="Go to Gateways" href="/gateways">
  ...
  <Card title="Delegators" icon="coins" cta="Go to Delegators" href="/delegators">
    LPT holders who stake to an orchestrator.

    **Roles**: Stake LPT, earn rewards, participate in governance and voting
  </Card>
  <Card title="Platforms? Workers?" icon="laptop-code" cta="Go to Platforms" href="/developers">
