...
keywords: ["livepeer", "gateways", "about gateways", "gateway economics", "gateway", "economics", "learn", "running"]
...
[Streamplace](https://stream.place) is a gateway that provides video processing services to content creators.
...
[Daydream](https://daydream.live) is another example of a gateway that provides AI video processing services.
