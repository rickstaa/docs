...
## About Gateways
- [Gateway Architecture](about-gateways/gateway-architecture.mdx)
- [Gateway Economics](about-gateways/gateway-economics.mdx)
- [Gateway Explainer](about-gateways/gateway-explainer.mdx)
- [Gateway Functions & Services](about-gateways/gateway-functions.mdx)
- [⚠️ Gateways Overview](about-gateways/overview.mdx)
- [⚠️ Gateway Quickstart](about-gateways/quickstart-home.mdx)
...
- [Community Guides](guides-and-resources/community-guides.mdx)
- [Community Projects](guides-and-resources/community-projects.mdx)
...
### Test
- [Playback Content using VLC Media Player](run-a-gateway/test/playback-content.mdx)
- [Publish Content](run-a-gateway/test/publish-content.mdx)
- [AI Gateway Test](run-a-gateway/test/test-gateway.mdx)

### V1
- [⚠️ Configure Transcoding Options](run-a-gateway/v1/transcoding-options.mdx)

## Using Gateways
- [Gateway Services](using-gateways/choosing-a-gateway.mdx)
- [Gateway Providers](using-gateways/gateway-providers.mdx)

### Gateway Providers
- [Cloud Spe Gateway](using-gateways/gateway-providers/cloud-spe-gateway.mdx)
- [Daydream Gateway](using-gateways/gateway-providers/daydream-gateway.mdx)
- [Livepeer Studio Gateway](using-gateways/gateway-providers/livepeer-studio-gateway.mdx)
