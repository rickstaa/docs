...
icon: linux
keywords: ["livepeer", "gateways", "run a gateway", "install", "linux install", "linux", "gateway"]
...
Jump to [Configuration](/gateways/run-a-gateway/configure/configuration-overview) to
