...
icon: windows
keywords: ["livepeer", "gateways", "run a gateway", "install", "windows install", "windows", "gateway"]
...
import { latestVersion as version} from '/snippets/automations/globals/globals.jsx'
...
>
  ...
  Options](/gateways/run-a-gateway/configure/configuration-overview) to finish
