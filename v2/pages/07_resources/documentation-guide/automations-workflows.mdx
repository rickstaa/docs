...
# Process single file
node tools/scripts/snippets/generate-seo.js --file=v2/pages/00_home/mission-control.mdx
```
...
**File:** `tools/scripts/snippets/generate-docs-status.js`
...
For intentional `.whitelist` edits by a human, use:
