...
description: A look at the thriving Livepeer ecosystem and it's partner integrations that expand the network's capabilities.
...
<Columns cols={2}> 
    <Card title="Livepeer Showcase" icon="clapperboard-play" href="../project-showcase" horizontal arrow> Explore Projects </Card>
    <Card title="Livepeer Products" icon="film-canister" href="../../010_products/products-portal" horizontal arrow > Explore Products</Card>
</Columns>
